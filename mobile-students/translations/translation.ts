...
const translations = {
  ...
  ja: {
    ...
    hasUppercase: "大文字を少なくとも1つ含める",
    hasLowercase: "小文字を少なくとも1つ含める",
    hasSpecialChar:
      "特殊文字を少なくとも1つ含める (!@#%&/\\,><':;|_~`+=^$.()[]{}?\" )",
  ...
  uz: {
    ...
    verifyEmailError:
      "Elektron pochta manzilini tekshirishda xatolik yuz berdi.",
    ...
    googleAuthFailed:
      "Google orqali autentifikatsiya muvaffaqiyatsiz. Iltimos, qayta urinib ko'ring.",
    googleCallbackFailed:
      "Google callback qayta ishlashida xatolik yuz berdi. Iltimos, qayta urinib ko'ring.",
    oauthMissingParams:
      "Google orqali autentifikatsiya amalga oshmadi. Kerakli kirish ma'lumotlari yo'q. Iltimos, qayta urinib ko'ring.",
    googleLoginFailed:
      "Google orqali kirish muvaffaqiyatsiz. Iltimos, qayta urinib ko'ring.",
    // new shared message key
    temporaryPasswordIfRegistered:
      "Agar elektron pochta ro'yxatdan o'tgan bo'lsa, vaqtinchalik parol yuborildi.",
    settingsHeader: "Sozlamalar",
    registrationCodeSent:
      "Agar bu telefon raqami ro'yxatdan o'tgan bo'lsa, tasdiqlash kodi yuboriladi",
  ...
  ru: {
    ...
    savePasswordFailed:
      "Не удалось сохранить пароль. Пожалуйста, попробуйте снова.",
    emailNotFoundAdmin:
      "Адрес электронной почты не найден в системе. Пожалуйста, свяжитесь с администратором школы.",
    googleAuthFailed:
      "Ошибка аутентификации Google. Пожалуйста, попробуйте снова.",
    googleCallbackFailed:
      "Ошибка обработки обратного вызова Google. Пожалуйста, попробуйте снова.",
    oauthMissingParams:
      "Невозможно выполнить вход через Google. Отсутствуют необходимые данные для входа. Пожалуйста, попробуйте снова.",
    googleLoginFailed:
      "Вход через Google не удался. Пожалуйста, попробуйте снова.",
    // new shared message key
    temporaryPasswordIfRegistered:
      "Если адрес электронной почты зарегистрирован, на него был отправлен временный пароль.",
    settingsHeader: "Настройки",
    registrationCodeSent:
      "Если этот номер телефона зарегистрирован, вы получите код подтверждения",
